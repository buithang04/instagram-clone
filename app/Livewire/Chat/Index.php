...
class Index extends Component
{
    ...
    {
        return <<<'HTML'
            <div class="w-full h-[calc(100vh_-_0.0rem)] flex bg-white rounded-lg text-black ">

                <!-- chatlist -->

                <div class="relative w-full h-full md:w-[320px] xl:[w-400] border-r shrink-0 overflow-y-auto">
                ...
                <main class=" hidden md:grid w-full h-full relative overflow-y-auto " style="contain:content" > 
                    <div class="m-auto text-center justify-center flex gap-3 flex-col items-center col-span-12">
                        ...
                        <h4 class="font-medium text-lg">Send private photos and message</h4>
                    </div>

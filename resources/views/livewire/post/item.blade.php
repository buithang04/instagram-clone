<div class="max-w-lg mx-auto text-gray-800">


    {{-- header --}}

    <header class="flex items-center gap-3">
        <x-avatar src="https://i.pravatar.cc/150?img" class="h-9 w-9" />
        <div class="grid grid-cols-7 w-full gap-2">
            ...
            <div class="col-span-2 flex text-right justify-end">
                <button class="text-gray-600 ml-auto">
        ...
        new Swiper($el, {
            ...
            navigation: {
                ...
                <div class="swiper-button-prev absolute top-1/2 z-10 p-2">
                    <div class="bg-white/70 border p-1 rounded-full text-gray-600/60 ">
    ...
    <footer class="mt-auto" >
        ...
        <div class="flex gap-4 items-center my-2">
            ...
            <span>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                    class="bi bi-send h-5 w-5" viewBox="0 0 16 16">
                    <path
        ...
        @auth
            ...
            <ul class="my-2">
                ...
                <li class="grid grid-cols-12 text-sm items-center">
                    ...
                    <button class="col-span-1 text-right ml-auto flex justify-end pr-px">
                        {{-- heart --}}
        ...
        x-data="{body:@entangle('body')}" class="grid grid-cols-12 items-center w-full">
            @csrf

<div class="bg-white  lg:h-[500px] flex flex-col gap-y-4 px-5  text-gray-900">


    <header class="w-full py-2 border-b">
        <div class="flex justify-between">
            <button @disabled(count($media)==0) wire:loading.attr="disabled" wire:click="$dispatch('closeModal')" class="font-bold">
                X
            </button>
            ...
            <button wire:click='submit' class="text-blue-500 font-bold">
                Share
            </button>
    ...
    <main class="grid grid-cols-12 gap-3 h-full overflow-hidden">
        ...
        <aside class="lg:col-span-7 m-auto items-center w-full ">   
            ...
            <label for="customFileInput"
                class=" m-auto max-w-fit flex flex-col gap-3 items-center cursor-pointer p-4 rounded-lg ">
                <input wire:model.live='media' type="file" multiple accept=".jpg,.png,.jpeg,.mp4" id="customFileInput" class="sr-only">
                ...
                <div class="  flex flex-col items-center gap-3">
                    ...
                    <span class="bg-blue-500 text-white text-sm rounded-lg p-2 px-4 font-semibold">
                        Upload files from computer
                    </span>
                </div>
            </label>
            @else
                <div class="flex overflow-auto  h-96 snap-x snap-mandatory gap-2 px-2" >
        ...
        {{-- details --}}
        <aside class="lg:col-span-5 h-full border-l p-3 flex gap-4 flex-col overflow-auto">
            {{-- Auther --}}
            ...
            {{-- description --}}
            <div>
                <textarea wire:model="description" class="border-0 focus:border-0 px0 w-full rounded-lg bg-white h-32 focus:outline-none focus:ring-0"
            ...
            <div class="w-full items-center">
                ...
                class="border-0 focus:border-0 px0 w-full rounded-lg bg-white  focus:outline-none focus:ring-0">
            </div>

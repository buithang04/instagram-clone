...
class=" w-full overflow-hidden  h-full text-black  ">
    ...
    <div class="  border-r   flex flex-col  grow  h-full">
        ...
        <header   class="w-full  sticky inset-x-0 flex pb-[5px] pt-[7px] top-0 z-10 bg-white border-b">
            ...
            <div class="  flex  w-full items-center   px-2   lg:px-4 gap-2 md:gap-5 ">
                ...
                <a href="{{route('chat')}}" class=" shrink-0 lg:hidden  " id="chatReturn">
        ...
        id="conversation"
        class="flex flex-col   gap-5   p-2.5   flex-grow  overscroll-contain  overflow-x-hidden w-full my-auto ">

            <!--Message-->

            @foreach ($loadedMessage as $message )
                @php
                ...
                <div @class([
                    ...
                    <div @class([
                        ...
                        <x-avatar class="h-7 w-7 lg:w-11 lg:h-11 " src="https://i.pravatar.cc/500?img=" />
                    </div>
                ...
                <form  wire:submit='sendMessage' method="POST" autocapitalize="off" class="col-span-11 md:col-span-9 ">
                    ...
                    <div class="grid grid-cols-12">
                        <input autocomplete="off" wire:model='body' id="sendMessage"
                            ...
                            class="col-span-11  border-0  outline-0 focus:border-0 focus:ring-0  hover:ring-0 rounded-lg        focus:outline-none   " />

                        <button type="submit" class="col-span-1 text-blue-500 font-bold ml-auto">Send</button>

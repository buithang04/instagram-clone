<div x-data="{
    ...
    }" class="menu  p-3  w-20 overflow-x-hidden h-full  grid  border-r text-black"
    :class="{'w-72 ':!shrink}">
    ...
    <footer class="sticky bottom-0 mt-auto w-full grid px-3 z-50 ">
        <div class="dropdown dropdown-top ">
            ...
            <ul tabindex="0" class="dropdown-content z-[1] menu p-2 space-y-3 shadow   rounded-box w-60">
                ...
                <li>
    <a href="#" class="py-2 flex items-center gap-5" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
        <span>
            <!-- icon logout -->
        </span>
        <h4>Logout</h4>
